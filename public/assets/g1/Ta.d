...
func void TA_SmokeSmalltalk		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_SmokeSmalltalk ,		waypoint);};
...
func void TA_SelfSmalltalk		(var int start_h, var int start_m, var int stop_h, var int stop_m, var string waypoint)	{TA_Min 	(self,	start_h,start_m, stop_h, stop_m,ZS_SelfSmalltalk,		waypoint);};
func void TA_SelfSmalltalkDrink		(var int start_h, var int start_m, var int stop_h, var int stop_m, var string waypoint)	{TA_Min 	(self,	start_h,start_m, stop_h, stop_m,ZS_SelfSmalltalkDrink,		waypoint);};
...
func void TA_MQueen					    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m, ZS_MQueen ,				waypoint);};
...
func void TA_WatchFight		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_WatchFight_Arena,		waypoint);};
func void TA_Search		    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_Search,		waypoint);};
func void TA_PreachPsi      (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_PreachPsi,		waypoint);};