...
{
	name 					=	"Ciyn¿ki pancyrz Wachtyrza";
...
{
	name 					=	"Ciyn¿ki pancyrz Najemnioka";
...
{
	name 					=	"Ciyn¿ki pancyrz Œwiäntynny";
...
{
	name 					=	"Staro¿ytny pancyrz magiczny";
	...
	description				=	name;
	TEXT[0]					=	"Tê staro¿ytn¹ zbrojê wykonano z magicznego wänglo.";
	TEXT[1]					=	NAME_Prot_Edge;			COUNT[1]	= protection	[PROT_EDGE];
	TEXT[2]					=	NAME_Prot_Point;		COUNT[2]	= protection	[PROT_POINT];
	TEXT[3] 				=	NAME_Prot_Fire;			COUNT[3]	= protection	[PROT_FIRE];
	TEXT[4]					=	NAME_Prot_Magic;		COUNT[4]	= protection	[PROT_MAGIC];
...
{
	name 					=	"Wzmocniäny pancyrz magiczny";
