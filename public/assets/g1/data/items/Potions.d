...
// FIXME: Textanzeige der Attribut-Änderung bei Benutzung móglich?
...
INSTANCE ItFo_Potion_Mana_01(C_Item)
{
	...
	description			= "Esencyjo magiczny energii";
...
INSTANCE ItFo_Potion_Mana_02(C_Item)
{
	...
	description			= "Wyciäng magiczny energii";
...
INSTANCE ItFo_Potion_Mana_03(C_Item)
{
	...
	description			= "Eliksir magiczny energii";
...
INSTANCE ItFo_Potion_Health_01(C_Item)
{
	...
	description			= "Esencyjo uzdrawiajänco";
...
INSTANCE ItFo_Potion_Health_02(C_Item)
{
	...
	description			= "Wyciäng uzdrawiajäncy";
...
INSTANCE ItFo_Potion_Health_03(C_Item)
{
	...
	description			= "Eliksir uzdrawiajäncy";
...
INSTANCE ItFo_Potion_Elixier_Egg(C_Item)
{
	...
	description			= "Brauza ze pe³zokäw";
	TEXT[0]				= "Po ni poradzi sie godaæ ze Nynokiem.";
...
INSTANCE ItFo_Potion_Haste_01(C_Item)
{
	...
	description		= "Brauza letkoœci";
	TEXT[1]			= "Po ni poradzi gibci lotaæ ale ino na chwila.";
...
INSTANCE ItFo_Potion_Haste_02(C_Item)
{
	...
	description		= "Brauza Gibkoœci";
	TEXT[1]			= "Po ni poradzi gibci lotaæ.";
...
INSTANCE ItFo_Potion_Haste_03(C_Item)
{
	...
	description		= "Brauza przyspieszynio";
	TEXT[1]			= "Po ni poradzi fest gibko lotaæ.";
