...
INSTANCE ItArRuneTeleport1 (C_Item)
{
	...
	spell				= 	SPL_TELEPORT1;
//mag_circle 			= 	4;   //SN: Teleport-Spells m√ºssen auch ohne Circle sprechbar sein!

	description			= 	"Teleportacyjo do Uconych ‘gnio";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
//mag_circle 			= 	4;   //SN: Teleport-Spells m√ºssen auch ohne Circle sprechbar sein!
	...
	description			= 	"Teleportacyjo do Uconych Wody";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArRuneTeleport3 (C_Item)
{
	...
	description			=	"Teleportacyjo do Nekromanty";	//blaue Rune
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArScrollTeleport3 (C_Item)
{
	...
	description			=	"Teleportacyjo do Nekromanty";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArScrollTeleport4 (C_Item)
{
	...
	description			= 	"‘rkowe zaklyÒcie teleportacyi";
...
INSTANCE ItArRuneTeleport5 (C_Item)
{
	...
	visual				=	"ItAr_Rune_39.3ds";	//gr√ºne Rune
	material			=	MAT_STONE;

	spell				= 	SPL_TELEPORT5;
//mag_circle 			= 	4;   //SN: Teleport-Spells m√ºssen auch ohne Circle sprechbar sein!

	description			=	"Teleportacyjo do lagru na barzo≥ach";	//lila Rune
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArScrollTeleport5 (C_Item)
{
	...
	description			=	"Teleportacyjo do lagru na barzo≥ach";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_TELEPORT;
};
...
INSTANCE ItArScrollTrfBloodfly (C_Item)
{
	...
	description			=	"Przemiana we koprucha";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfCrawler (C_Item)
{
	...
	description			=	"Przemiana we pe≥zoka";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfLurker (C_Item)
{
	...
	description			=	"Przemiana we utopka";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfMeatbug (C_Item)
{
	...
	description			=	"Przemiana we chroboka";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfMolerat (C_Item)
{
	...
	description			= "Przemiana we paskudnioka";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfOrcdog (C_Item)
{
	...
	description			=	"Przemiana we Ùrkowego psa";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfScavenger (C_Item)
{
	...
	description			=	"Przemiana we padlinioka";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfShadowbeast (C_Item)
{
	...
	description			=	"Przemiana we ciyniom‰nstra";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfSnapper (C_Item)
{
	...
	description			=	"Przemiana we zymboka";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfWaran (C_Item)
{
	...
	description			= "Przemiana we gadzina";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollTrfWolf (C_Item)
{
	...
	description			= "Przemiana we wilca";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
// FIXME: kann man die DAMAGE_PER_LEVEL-Werte der Spells aus der Spells_Params hier f√ºr Manakosten einsetzen??
...
INSTANCE ItArRuneIceCubeSmall (C_Item)
{
	name 				=	NAME_Rune;
	...
	spell				= 	SPL_SMALLICECUBE;
	mag_circle 			=	3;

	description			=	"Ma≥o bry≥a lodu";
	TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
	TEXT	[1]			=	NAME_Manakosten;			COUNT	[1]		=	SPL_SENDCAST_ICECUBE;
	TEXT	[2]			=	NAME_Damage;				COUNT	[2]		=	SPL_FREEZE_DAMAGE;
	//TEXT	[3] 		=	"";							COUNT	[3]		=	;
...
/*******************************************************************************************
**  D√§monenbeschw√≥rer	 (Runensteine  und Scrolls)										  **
*******************************************************************************************/
...
INSTANCE ItArScrollSummonDemon (C_Item)
{
	...
	description			=	"Przyzw‰nie diobliska";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollSummonSkeletons (C_Item)
{
	...
	description			=	"Przyzw‰nie szkelet‰w";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
INSTANCE ItArScrollSummonGolem (C_Item)
{
	...
	description			=	"Przyzw‰nie bergmona";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
...
/*******************************************************************************************
**  PSI-Spr√ºche		(Runen und Scrolls)													  **
*******************************************************************************************/
...
INSTANCE ItArScrollShrink (C_Item)
{
	...
	description			=	"Zmniyjszynie m‰nstra";
	//TEXT	[0]			=	NAME_Mag_Circle;			COUNT	[0]		=	mag_circle;
