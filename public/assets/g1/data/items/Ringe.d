	...
	instance Schutzring_Feuer1(C_Item)
{
	...
	description		= " Pierœciyñ ôchrony przed fojeräm";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Feuer2(C_Item)
{
	...
	description		= "Ôchrona przed fojeräm";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Fire;
	...
	INSTANCE Schutzring_Geschosse1(C_Item)
{
	...
	description		= "Pierœciyñ skäry ze drzewa";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Geschosse2(C_Item)
{
	...
	description		= "Pierœciyñ kamienny skäry";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Point;
	...
	INSTANCE Schutzring_Waffen1(C_Item)
{
	...
	description		= "Pierœciyñ ¿elazny skäry";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Waffen2(C_Item)
{
	...
	description		= "Pierœciyñ magicznygo pancyrza";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Magie1(C_ITEM)
{
	...
	description		= "Pierœciyñ siy³y duchowy";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Schutzring_Magie1_Fire1(C_ITEM)
{
	...
	description		= "Pierœciyñ ôczyszczynio";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Magic;
	...
	INSTANCE Schutzring_Magie2_Fire2(C_ITEM)
{
	...
	description		= "Pierœciyñ niezwyciyn¿onoœci";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Magic;
	...
	INSTANCE Schutzring_Geschosse1_Waffen1(C_ITEM)
{
	...
	description		= "Pierœciyñ wytrwa³oœci";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Geschosse2_Waffen2(C_ITEM)
{
	...
	description		= "Pierœciyñ niewzruszonoœci";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Prot_Edge;
	...
	INSTANCE Schutzring_Total1(C_ITEM)
{
	...
	description		= "Ma³y pierœciyñ niezwyciyn¿onoœci";
	//TEXT[0]			= "";
	...
	INSTANCE Schutzring_Total2(C_ITEM)
{
	...
	description		= "Dupny pierœciyñ niezwyciyn¿onoœci";
	//TEXT[0]			= "";
	TEXT[1]			= NAME_Prot_Magic;
	COUNT[1]		= 3;
	TEXT[2]			= NAME_Prot_Fire;
		...
		INSTANCE Ring_des_Geschicks(C_Item)
{
	...
	description		= "Ma³y pierœciyñ zwinnoœci";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	...
	INSTANCE Ring_des_Geschicks2(C_Item)
{
	...
	description		= "Dupny pierœciyñ zwinnoœci";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Dex;
	...
	INSTANCE Ring_des_Lebens2(C_Item)
{
	...
	description		= "Dupny pierœciyñ ¿ycio";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_HP;
		...
		INSTANCE Ring_der_Erleuchtung(C_Item)
{
	...
	description		= "Pierœciyñ ôœwiecynio";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Mana;
	...
	INSTANCE Machtring(C_Item)
{
	...
	description		= "Pierœciyñ siy³y wojoka";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
	TEXT[2]			= NAME_Bonus_Str;
