	...
	INSTANCE  Schutzamulett_Geschosse(C_ITEM)
{
	...
	description		= "Amolet Dymbowy Sk鋜y";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Magie(C_ITEM)
{
	...
	description		= "Amolet Duchowy Siy硑";
	//TEXT[0]			= "";
	...
	INSTANCE  Schutzamulett_Magie_Feuer(C_ITEM)
{
	...
	description		= "Amolet 詂zyszczynio";
	//TEXT[0]			= "";
	TEXT[2]			= NAME_Prot_Fire;
	COUNT[2]		= 10;
		...
		INSTANCE  Schutzamulett_Waffen_Geschosse(C_ITEM)
{
	...
	description		= "Amolet Kamiynny Sk鋜y";
	//TEXT[0]			= "";
	TEXT[2]			= NAME_Prot_Edge;
	COUNT[2]		= 15;
...
{
	name 			=	"Amolet Magicznygo Pancyrza";
	...
	description		= "Amolet Magicznygo Pancyrza";
	//TEXT[0]			= "";
...
/******************************************************************************************/
/*
// FIXME: was soll das machen? D盲mon beschw贸ren???
	INSTANCE  Beschw贸rungsamulett(C_Item)
{
	...
	visual_skin 		=	0;
	material 		=	MAT_METAL;
	on_equip		=	Equip_Beschw贸rungsamulett;
	on_unequip		=	UnEquip_Beschw贸rungsamulett;
	description		= "D盲monenbeschw贸rung";
	TEXT[0]			= "Schwarz wie die Seele";
	TEXT[1]			= "Schwarz wie die Nacht";
	////COUNT[1]		= ;
	TEXT[2]			= "Schwarz wie das B贸se";
	////COUNT[2]		= ;
	...
	FUNC VOID Equip_Beschw贸rungsamulett()
	{
	...
	FUNC VOID UnEquip_Beschw贸rungsamulett ()
	{
