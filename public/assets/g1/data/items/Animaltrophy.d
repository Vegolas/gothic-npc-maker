...
So in der Tasche
----------------
ItAt_Meatbug_01 	//Meatbug			Kórper (Essen)		(Item-Instanz in Food.d)
...
{
	name 				=	"Platka ze pancyrza pe³zoka";
	...
	description			= "Fragmynt pancyrza pe³zoka.";
...
INSTANCE ItAt_Shadow_01 (C_Item)
{
	...
	description			= "Skära ciyniomänstra";
...
{
	name 				=	"Serce Kamiynnygo Bergmona";
	...
	description			= name;
	TEXT[0]				= "To je serce ze szczäntkäw";
	TEXT[1]				= "pokonanygo kamiennygo Bergmona.";
	TEXT[2]				= "Jego magiczno moc pozwolo"; 
	TEXT[3]				= "wyciepaæ przeciwnika furt wysoko.";
...
INSTANCE ItAt_FireGolem_01 (C_Item)
{
	...
	description			= name;
	TEXT[0]				= "To serce je ze szczäntkäw";
	TEXT[1]				= "pokonanygo ôgnistygo Bergmona.";
	TEXT[2]				= "Jego magiczno moc pozwolo";
	TEXT[3]				= "hajcnäñæ przeciwnika.";
...
INSTANCE ItAt_IceGolem_01 (C_Item)
{
	...
	description			= name;
	TEXT[0]				= "To serce je ze szczäntkäw";
	TEXT[1]				= "pokonanygo lodowego Bergmona.";
	TEXT[2]				= "Jego magiczno moc pozwolo";
...
{
	name 				=	"Fragmynt Lodowygo Bergmona";
	...
	description			= name;
	TEXT[0]				= "Tyn fragmynt je ze szczäntkäw";
	TEXT[1]				= "pokonanygo lodowygo Bergmona.";
